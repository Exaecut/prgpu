...
fn main() {
    ...
    pipl::plugin_build(vec![
        ...
        Property::Name("EX Chromatic Aberration"),
        ...
        Property::AE_Effect_Match_Name("EXAE Chromatic Aberration"),
        Property::AE_Reserved_Info(0),
        Property::AE_Effect_Support_URL("https://exaecut.io/issues/chromatic-aberration"),
    ])
}
