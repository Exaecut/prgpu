...
pub fn setup(params: &mut Parameters<Params>, _in_data: InData, _out_data: OutData) -> Result<(), Error> {
	...
	params.add(Params::Anchor, "Anchor", ae::PointDef::setup(|f| {
		f.set_default((50.0, 50.0));
		f.set_value((50.0, 50.0));
	}))?;

	params.add(Params::ScaleX, "Scale - X", ae::FloatSliderDef::setup(|f| {
		f.set_default(1.0);
		f.set_value(1.0);
	...
	params.add(Params::ScaleY, "Scale - Y", ae::FloatSliderDef::setup(|f| {
		f.set_default(1.0);
		f.set_value(1.0);
		f.set_slider_min(0.0);
		f.set_slider_max(5.0);
	...
	params.add(Params::NoiseTimeOffset, "Noise - Phase", ae::AngleDef::setup(|f| {
		f.set_default(0.0);
		f.set_value(0.0);
	}))?;
	...
	params.add(Params::BlurQuality, "Blur - Quality", ae::FloatSliderDef::setup(|f| {
		f.set_default(2.0);
		f.set_value(2.0);
		f.set_slider_min(1.0);
